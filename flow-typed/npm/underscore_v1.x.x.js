...
declare module 'underscore' {
  ...
  declare function findIndex<T>(
    list: T[],
    predicate: $Shape<T> | ((val: T) => boolean)
  ): number;
  ...
  declare function mapObject<T, U>(
    object: Dictionary<T>,
    iteratee: (val: T, key: string, object: Dictionary<T>) => U,
    context?: any
  ): Dictionary<U>;
  declare function mapObject<T>(
    object: any,
  ...
  declare function reduce<T, MemoT>(
    a: Array<T>,
    iterator: (m: MemoT, o: T) => MemoT,
    initialMemo?: MemoT
  ): MemoT;
  declare function inject<T, MemoT>(
    a: Array<T>,
    iterator: (m: MemoT, o: T) => MemoT,
    initialMemo?: MemoT
  ): MemoT;
  declare function foldl<T, MemoT>(
    a: Array<T>,
    iterator: (m: MemoT, o: T) => MemoT,
    initialMemo?: MemoT
  ): MemoT;
  declare function reduceRight<T, MemoT>(
    a: Array<T>,
    iterator: (m: MemoT, o: T) => MemoT,
    initialMemo?: MemoT
  ): MemoT;
  declare function foldRight<T, MemoT>(
    a: Array<T>,
    iterator: (m: MemoT, o: T) => MemoT,
    initialMemo?: MemoT
  ): MemoT;
  ...
  declare function groupBy<T>(
    a: Array<T>,
    iteratee: (val: T, index: number) => any
  ): { [key: string]: T[] };
  ...
  declare function size<T>(list: Collection<T>): number;
  // TODO: improve this
  ...
  declare function toArray<T>(list: Collection<T>): T[];
}
