...
var Backstroke = function Backstroke(config) {
  ...
  function buildTrip(checkins, number) {
    var startDate = _.first(checkins).created,
        endDate = _.last(checkins).created,
        start = startDate.format("MMMM D, YYYY"),
        end = endDate.format("MMMM D, YYYY"),
        rangeStart = startDate.format("MM/DD"),
        rangeText = startDate.isSame(endDate) ? rangeStart : rangeStart + " to " + endDate.format("MM/DD"),
